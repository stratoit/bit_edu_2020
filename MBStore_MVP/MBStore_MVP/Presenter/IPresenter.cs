...
namespace MBStore_MVP.Presenter
{
    ...
    interface IInputCustomer
    {
        ...
        bool InsertSalesHistroy(int customer_id, int employee_id, DateTime sales_date, Boolean refunded);
        int SelectMaxHistoryId(int employee_id);
        bool InsertSalesProduct(int history_id, int product_id, int quantity, string color, string color_value, string type);
        bool UpdateStockProduct(int product_id, string color, int quantity);
        bool UpdateCustomerSavings(int customer_id, long savings);
    }
    ...
    interface IMainWindow
    {
        ...
        bool UpdateSalesHistory(int sales_history_id);
        bool InsertSalesHistroy(int customer_id, int employee_id, DateTime sales_date, Boolean refunded);
        int SelectMaxHistoryId(int employee_id);
        bool InsertSalesProduct(int history_id, int product_id, int quantity, string color, string color_value, string type);
        bool UpdateStockProduct(int product_id, string color, int quantity);
        ...
        Product Set_Lo_Input_Product(string sql);
        Product Set_Lo_Input_History(string sql);
        string Select_productname_id(int product_id);
        Int32 Lo_Check_Stock(int id, string color);
        bool Set_Lo_Return_Stock(Return_Info return_Info, int eid);
